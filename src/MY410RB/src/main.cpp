/*******************************************************************************
 * Test unit for the development board: STM32F410RBTx
 * *****************************************************************************
...
public:
    ...
    void run ()
    {
        ...
        status = timer.start(TIM_COUNTERMODE_UP, System::getMcuFreq()/2000 - 1,  990);
...
int main(void)
{
    ...
    // Set system frequency to 100MHz
    ...
    clkDiv.APB1CLKDivider = RCC_HCLK_DIV4;
    clkDiv.APB2CLKDivider = RCC_HCLK_DIV2;
    do
    {
